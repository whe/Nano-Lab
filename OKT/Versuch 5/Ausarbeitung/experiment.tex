...
%\begin{adjustwidth}{0cm}{0cm}
	...
	\subfloat[TE03]{\includegraphpuics[totalheight=4.5 cm]{Grafiken/modes_TE03.pdf} \label{fig:1_TE03}}
...
\centering
%\begin{adjustwidth}{0cm}{0cm}
	\subfloat[TE02]{\includegraphics[totalheight=4.5 cm]{Grafiken/modes_TE_2_0_02.pdf}\label{fig:1_TE02_2}}
	\subfloat[TM02]{\includegraphics[totalheight=4.5 cm]{Grafiken/modes_TM_2_0_02.pdf} \label{fig:1_TM02_2}}
...
For $B = 0$ the normalized frequency is $V = 0$. That means that $f = 0$ as well, and $n_{\mathrm{eff}}= 1$. Here both diagrams, \ref{fig:singlemoded} and \ref{fig:1_neff} show the same.
...
\caption{Simulated quasi TE modes}%
\label{fig:3TE}%
\end{figure}
