...
\begin{equation}
BER = \frac{1}{4}\mathrm{erfc}\left(\frac{\mu\i{s}-\mu_0}{\sqrt{2}\sigma_0}\right)+\frac{1}{4}\mathrm{erfc}\left(\frac{\mu\i{1}-\mu\i{s}}{\sqrt{2}\sigma_1}\right)
\label{eq:}
\end{equation}
...
\label{eq:}
\end{equation}
the decision threshold level $\mu\i{s}$ and the mean values $\mu_1$ of the mark and $\mu_0$ of the space.
