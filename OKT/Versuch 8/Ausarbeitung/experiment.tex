...
\begin{figure}%
\centering
	\subfloat[]{\includegraphics[width=.5\columnwidth]{Grafiken/C_setup1.png}\label{fig:C_setup1}}~~~~~~~~~
	\subfloat[]{\includegraphics[width=.5\columnwidth]{Grafiken/C_setup2.png}\label{fig:C_setup2}}%
