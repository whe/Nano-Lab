...
%\begin{adjustwidth}{0cm}{0cm}
	\subfloat[A/k]{\includegraphics[totalheight=6 cm]{Grafiken/Ak_1.pdf}\label{fig:Profil_3D}~}
	\subfloat[A/z]{\includegraphics[totalheight=4 cm]{Grafiken/Az_1.pdf} \label{fig:1ct}}\\%
	\subfloat[trunked A/z]{\includegraphics[totalheight=6 cm]{Grafiken/Az_trunc1.pdf}\label{fig:Az_1_trunc}~}
