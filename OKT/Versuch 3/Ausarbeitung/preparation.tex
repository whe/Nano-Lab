...
\caption{Main peak of $\breve{S}(z)$.}%
\label{fig:fwhm}%
\end{figure}
...
In a .mat file the measurement of the interface term of a spool of adhesive tape $\hat{u}(k_m)$ is given. To calculate the term in the spacial domain $\hat{u}(z)_{sr}$ the matlab function \verb|fft()| is used. The absolute of the result $\hat{u}(z)_{sr}$ is shown in \ref{fig:profile}
