...
\comwo{Nochmal ohne Korrespondenz, sondern selbst gerechnet:... überleg dir was richtig ist}
...
=		\frac{P}{\sqrt{2\pi}}\Delta k \cdot\mathrm{si}(\frac{\Delta k}{2}z)
\end{split}
\end{equation}
...
\begin{equation}
\breve{S}(z) = \frac{P}{\sqrt{2\pi}}\Delta k \cdot\mathrm{si}(\frac{\Delta k}{2}z)\cdot\mathrm{e}^{-jzk_0}
\label{eq:S_ortsraum}
\end{equation}
