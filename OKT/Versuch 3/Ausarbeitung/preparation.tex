...
At $z\approx1.6$~mm the signal shows a good reflecting plane. Figure \ref{fig:profile_zoom} shows the range from 1.4 to 2.5~mm. Here the layer thickness of the tape can be estimated. The width of one major peak can be estemated as $\sim 40~\upmu$m. So the layer thickness is around 40~$\upmu$m as well.
