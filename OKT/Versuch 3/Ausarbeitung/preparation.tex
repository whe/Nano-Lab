...
Most noticable in figure \ref{fig:profile} is a large peak around $z=6.4$~mm and the increasing of $I$ for $z \rightarrow 8$~mm. This increasing of $I$ towards 8~mm are DC parts caused by non-interfering components. 
At $z\approx6.4$~mm the signal shows a good reflecting plane. At this position  xxx



\begin{figure}[ht]
  \centering
  \includegraphics[width=.6\columnwidth]{Grafiken/profile_mm.pdf}
