...
In the signal a periodicity of $\sim$40~$\upmu$m can be found. Because of sampling errors the periodicity is discontinuous. 
So the layer thickness is around 40~$\upmu$m as well.
