...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\columnwidth]{Grafiken/profile.pdf}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\columnwidth]{Grafiken/profile_nm.pdf}
...
\comwo{Beide Formeln können nicht passen... Klebeband ist nicht im nm Bereich. \ref{fig:profile_nm} wurde mit \eqref{eq:ohne_pi} gemacht }

\begin{equation}
z_m=\frac{1}{k_0-\frac{\Delta k}{2}+m\cdot\delta k}
\label{eq:ohne_pi}
\end{equation}

oder
\begin{equation}
z_m=\frac{\pi}{k_0-\frac{\Delta k}{2}+m\cdot\delta k}
\label{eq:}
\end{equation}
