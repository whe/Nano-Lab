...
\todo{Muss hier rein warum das so ist??}\comseb{im zweifel nein}
...
\todo{What parameters do we know?}\comwo{Muss das wirkilich rein?}\comseb{wir kennen alle ;) -> weglassen}
...
6 - Q Estimator im vorbereitungsdingens}\comseb{is schon in ordnung, ich weiß es auch net besser}
...
\todo{discuss the numerical values}\comseb{die ham wir eigentl discussed, wir ham gesagt das der zusammenhang linear is}
