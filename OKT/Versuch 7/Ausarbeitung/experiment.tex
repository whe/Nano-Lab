...
\begin{figure}%
\centering
\includegraphics[width=.5\columnwidth]{Grafiken/P3ExC_Q.pdf}%
\caption{\textit{Q}-factor over FWHM of the optical source}%
\label{fig:P3ExC_Q}%
\end{figure}

To measure the impulse's emporal half-maximum full-width differenz $\Delta t_{\mathrm{H}}$ a prepared bit sequence was loaded ("`costum_1.dat"') and a parameter scan was performet for the lenght of 10, 20, 30 and 40~km.
