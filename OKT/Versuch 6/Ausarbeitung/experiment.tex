...
\todo{Quality Berechnen, damit kappa und alpha}
$\delta f$ and $\Delta f$ can be extracted from the measurement are given in table \ref{tab:ring_klein}.
Using equations \eqref{eq:kappa} and \eqref{eq:alpha} $\kappa$ and $\alpha$ can be calculated. The values are given in \ref{tab:ring_klein} as well.

\todo{die Werte dann noch im Text nennen}
...
\caption{Transmission of the small ring resonator and a large ring resonator.}%
