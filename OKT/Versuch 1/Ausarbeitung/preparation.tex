...
From figure \ref{fig:Q1} the difference of two resonator wavelenth can be determined as about $\Delta\lambda\i{q} \approx 0.29$~nm. This corresponds to a frequency difference of $\Delta f\i{q} \approx 138$~GHz.

With the free spectral range and 
\begin{equation}
 \Delta f\i{q} = \frac{c}{2n\i{g}L} = \frac{1}{\tau\i{U}}
\end{equation}
$\tau\i{U}$ ca
