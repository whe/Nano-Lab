...
\paragraph{6. b)}
For operation of the laserdiode with low oszillation, the operation point of the diode should be in the domain of damped oszillation. There the resonance overshoot disappears for $2\gamma\i{r}>\omega\i{r}$. Thus the operation point should be chosen in that domain.
