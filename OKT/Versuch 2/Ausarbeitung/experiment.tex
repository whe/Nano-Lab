...
To measure the caracteristic of the laser diode a reverse voltage ov $U = -10$~V was applied to the APD and the series resistance $R_{\mathrm{V}}$. ``The voltage corresponds to an avalanche multiplication factor $M_0 \approx 1$''\footnotemark[3]%{Source: OKT Experiment 2: Photodiode analysis task-sheet}.
