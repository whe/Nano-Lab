...
To approximate the threshold a linear fitting of the curve was performed. Only values of $I_{\mathrm{L}} \geq 50$~mA were taken into account because the spontaneous emission is of no consequence there. Figure \ref{fig:T1_laser} shows the linear fit as well. This corresponds approximately to the tangent in the linear range.  The intercept with $I_{\mathrm{PIN}} = 0~\upmu$A is at $I_{\mathrm{th}} \approx 28$mA. This can be assumed as the threshold of the laser diode.
