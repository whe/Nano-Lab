...
\begin{equation}
\frac{1}{v_p} \frac{\partiali_p}{\partial t} +\frac{\partiali_p}{\partial x} = eFg_{\mathrm{photo}} 
\label{eq:}
\end{equation}
...
\begin{equation}
\frac{1}{v_n} \frac{\partiali_n}{\partial t} +\frac{\partiali_n}{\partial x} = eFg_{\mathrm{photo}} 
\label{eq:}
\end{equation}
...
\begin{equation}
eFg_{\mathrm{ion}} = \alpha_i i_n + \beta_i
\label{eq:}
\end{equation}
