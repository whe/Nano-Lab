...
A electron hole pair generated in the diffusion zone also leads to a current. Since the carriers in that zone move with their diffusion velocity, which is orders of magnitude smaller than the drift velocity in the intrinsic zone, generation in the diffusion zone is not wanted. The generation of carriers in the diffusion zone can be minimized by highly doping the semiconductor.
